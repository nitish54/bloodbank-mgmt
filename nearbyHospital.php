    ...
    <body>
        <div id="wrap"><!-- wrap starts here -->
           ...
           <code><span style="align: right; color: blue;"><label><?php echo "Hello ".$_SESSION['userid'] ?> </label></span></code>
            ...
            <div id="wside">
                <br/><br/>
               <font size="4" color="Blue"> Near By Hospitals to your District: </font><br/>    <br/>   
                <?php     
                ...
                echo "</tr>";
                $query1 = "SELECT name,address,district,state,contactno FROM bbms.bbhlogin where type='hospital' and status='approved' and district='$district'";
        ...
        <div class="scroll">
            <br/><br/>
          <font size="4" color="Blue">  Hospitals in your State: </font><br/><br/>
            <table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" >
                ...
                $query = "SELECT name,address,district,state,contactno FROM bbms.bbhlogin where type='hospital' and status='approved' and state='$state'";
