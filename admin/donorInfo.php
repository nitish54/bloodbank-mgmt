...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
 ...
 <style type="text/css">
    ...
    <body>
        ...
        $sql = "SELECT count(*) FROM bbms.donor";
        $result1 = mysql_query($sql);
        $row1 = mysql_fetch_array($result1);
        echo "<center><font size='3'color='blue'><br/><b>Total No. of registered Donors: " ."<u>". $row1[0]."</u></b></font><br/>";
        ?>
        <br/>
        <div class="scroll">
            <br/><br/>
            <table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" >
                <tr height="30"><th>User-id</th><th>Name</th>
                    <th>Blood Group</th><th>Sex</th>
                <th>Address</th><th>District</th>
                <th>State</th><th>Email ID</th>
                <th>Contact No.</th>
                
                </tr>
                <?php              
                $query = "SELECT userid,name,bloodgroup,sex,address,district,state,email,contactno FROM bbms.donor";
                $result = mysql_query($query);
                while ($row = mysql_fetch_array($result)) {
                    echo "<tr height='25'><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td>" . $row[2] . "</td><td>" . $row[3] . "</td><td>" . $row[4] . "</td><td>" . $row[5] . "</td><td>" . $row[6] . "</td><td>" . $row[7] . "</td><td>" . $row[8] . "</td></tr>";
                }
                echo "</table>";
                echo "<br/><br/>";
                ?>
