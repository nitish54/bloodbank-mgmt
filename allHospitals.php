...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
 ...
 <style type="text/css">
    ...
    <body>
        ...
        $sql = "SELECT count(*) FROM bbms.bbhlogin where type='hospital' and status='approved'";
        $result1 = mysql_query($sql);
        $row1 = mysql_fetch_array($result1);
        echo "<center><font size='3'color='blue'><br/><b>Total Number of Hospitals: " ."<u>". $row1[0]."</u></b></font><br/>";
        ?>
        <br/>
        <div class="scroll">
            <br/><br/>
            <table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" >
                ...
                <?php              
                $query = "SELECT name,address,district,state,contactno FROM bbms.bbhlogin where type='hospital' and status='approved'";
